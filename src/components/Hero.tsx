...
const Hero: FC = () => {
        return (
            ...
            <section className='relative flex-col flex w-screen lg:h-screen bg-[var(--hero-bg)] 2xl:px-52 2xl:pt-56 xl:px-40 xl:pt-16 lg:px-10 lg:pt-10  lg:flex-row md:flex-col h-full'>
                ...
                <Round className='2xl:w-[150px] 2xl:h-[150px] 2xl:right-24 xl:w-[100px] xl:h-[100px] xl:right-10 w-[90px] h-[90px] right-5 bg-[var(--rounded)]/40  absolute bottom-0 ' />
                </motion.div>
                <motion.div
                initial= {{ opacity:0, y: 1 }}
                animate = {{opacity : 1, y: 0}}
                ...
                <Round className='2xl:w-[850px] 2xl:h-[850px] xl:w-[650px] xl:h-[650px] md:w-[550px] md:h-[550px] w-[350px] h-[350px] bg-[var(--rounded)]/10  absolute  z-10 -left-20' />
                </motion.div>
                </div>
                {/* container 2  */}
                <div className='relative flex justify-center items-center   lg:w-full md:w-[550px] '>
                    ...
                    <Round className='2xl:w-[750px] 2xl:h-[750px] 2xl:left-10 2xl:top-40 xl:w-[450px] xl:h-[450px] xl:left-6 xl:top-28 lg:w-[350px] lg:h-[350px] w-[250px] h-[250px] left-12 top-28 bg-[var(--rounded)]  absolute  z-10' />
                    </motion.div>
                </div>
